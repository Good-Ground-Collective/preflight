    ...
    return [
    {
      ...
      rules: {
        ...
        '@typescript-eslint/member-ordering': [
          ...
          {
            default: {
              // memberTypes is exhaustive rather than a prefix, so a category left out is unranked and may sit anywhere; every leaf category is listed.
              memberTypes: [
                // Equal rank, because ranking a readonly index signature against a mutable one is an opinion nobody needs.
                ...
                'constructor',
                // Accessors are field-like reads, so they sit nearer the state they expose than the methods that act on it.
                'public-instance-get',
                'public-instance-set',
